...
return lush(function()
  return {
    ...
    -- Golang specific
    goDeclaration { fg = hsl('#00BFFF'), gui = "bold" },
    goDeclType { fg = hsl('#00BFFF'), gui = "bold" },
    goConst { fg = hsl('#00BFFF'), gui = "bold" },
    goType { fg = hsl('#00BFFF'), gui = "bold" },
    goVar { fg = hsl('#00BFFF'), gui = "bold" },
    goRepeat { fg = hsl('#00BFFF'), gui = "bold" },
    goConditional { fg = hsl('#00BFFF'), gui = "bold" },
    goStatement { fg = hsl('#00BFFF'), gui = "bold" },
    goBuiltins { fg = hsl('#00BFFF'), gui = "bold" },
    goImport { fg = hsl('#00BFFF'), gui = "bold" },
    goPackage { fg = hsl('#00BFFF'), gui = "bold" },
    goPredefinedIdentifiers { fg = hsl('#00BFFF'), gui = "bold" },
    goFloats { fg = hsl('#00BFFF'), gui = "bold" },
    goLabel { fg = hsl('#00BFFF'), gui = "bold" },
    goSignedInts { fg = hsl('#00BFFF'), gui = "bold" },
    -- Markdown specific
